...
<div id="slideshow-container">
    ...
    <tr>
		...
		// Fetch and  print all  the records.
			while  ($row =  $rows->fetch())	{
				echo "<tr><td align='left'><a href='project-details.php?data=".$row['pid']."'>".$row['title']."</a></td>";
    ...
    <div class="edit-btns">
        <a href="select-edit.php"><button class="button search-btn"> Edit </button></a>
        <a href="add.php"><button class="button search-btn"> Add</button></a>
    
</div>
    </div> <!-- closes the edit-btns div -->

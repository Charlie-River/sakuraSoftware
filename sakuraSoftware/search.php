    ...
    <nav class="nav">
      <?php
        ...
        <?php
            ...
            echo "<a class='active-nav' href='search.php'>Search</a>";
            ?>
        </div>
        <div class="users">
            <?php
        ...
        <div class="users">
            <?php
			echo "<button class=\"login-btn interested\" onclick=\"document.getElementById('login-form').style.display='block'\">Log In</button>";
...
<div id="slideshow-container">
    ...
    <form method="post" class="search-form">
        <input type="text" placeholder="search data" name="search" class="search-data">
        <button class="button search-btn" name="submit"> Search </button>
    </form>
    <div class="container">
...
<?php
              ...
              try {
                  ...
                  FROM projects
                  WHERE title like '%$search%' or end_date like '%$search%'";
                  //run  the query
                  $rows =  $db->query($query);
          ...
          <tr>
              ...
              // Fetch and  print all  the records.
                  while  ($row =  $rows->fetch())   {
                    echo "<tr><td align='left'><a href='project-details.php?data=".$row['pid']."'>".$row['pid']."</a></td>";
         ...
         ?>
            ...
            </div> <!-- Closes sldieshow container, ensures footer and container dont match -->
